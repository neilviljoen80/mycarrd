...
export function SiteRenderer({ site, isPro }: SiteRendererProps) {
    ...
    return (
        <div
            className={`min-h-screen flex flex-col items-center justify-center p-4 transition-all duration-700 ${styles.container.backgroundGradient || ""}`}
            style={{
            ...
            >
                ...
                <div className={`space-y-4 w-full flex flex-col ${textAlignClass}`}>
                    {site.profile_image_url && (
                        <div
                            className="relative w-32 h-32 overflow-hidden transition-transform hover:scale-105 duration-300"
                            style={{
