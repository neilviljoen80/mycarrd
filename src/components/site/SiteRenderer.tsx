    ...
    return (
        ...
        >
            ...
            >
                        ...
                        {site.links.map((link, index) => {
                            ...
                            return (
                                <a
                                    ...
                                    className={`group block w-full transition-all duration-300 hover:scale-[1.02] ${buttonRadiusClass} ${shadowClass[styles.buttons.shadow as keyof typeof shadowClass] || "shadow-none"}`}
                                    style={{
                ...
                {/* Footer Icons */}
                {styles.footer_icons && styles.footer_icons.length > 0 && (
                    <div className="flex justify-center gap-6 pt-8">
                        {styles.footer_icons.map((icon, idx) => {
                            const Icon = iconMap[icon] || Mail;
                            return (
                                <div
                                    key={idx}
                                    className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center bg-white/5 hover:bg-white/10 transition-all hover:scale-110 cursor-pointer shadow-lg backdrop-blur-sm"
                                >
